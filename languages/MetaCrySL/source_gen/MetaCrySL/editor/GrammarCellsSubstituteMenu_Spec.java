...
public class GrammarCellsSubstituteMenu_Spec extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Spec() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8haeln_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Spec", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8haeln_a extends GrammarCellsSubstituteMenuPart {
    @Override
