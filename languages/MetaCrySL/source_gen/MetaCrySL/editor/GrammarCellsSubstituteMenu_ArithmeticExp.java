...
public class GrammarCellsSubstituteMenu_ArithmeticExp extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ArithmeticExp() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cwbs1n_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ArithmeticExp", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cwbs1n_a extends GrammarCellsSubstituteMenuPart {
    @Override
