...
public class GrammarCellsSubstituteMenu_EventSpec extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EventSpec() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cmtj3g_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EventSpec", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cmtj3g_a extends GrammarCellsSubstituteMenuPart {
    @Override
