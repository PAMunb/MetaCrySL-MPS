...
/*package*/ class SpecRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SpecRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_fnrnui_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.ref$60YM;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.ref$60YM);
    }
