...
public class GrammarCellsSubstituteMenu_ForbiddenMethod extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ForbiddenMethod() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_67u6dr_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ForbiddenMethod", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_67u6dr_a extends GrammarCellsSubstituteMenuPart {
    @Override
