...
public class GrammarCellsSubstituteMenu_AddEvent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AddEvent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_7607uy_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AddEvent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_7607uy_a extends GrammarCellsSubstituteMenuPart {
    @Override
