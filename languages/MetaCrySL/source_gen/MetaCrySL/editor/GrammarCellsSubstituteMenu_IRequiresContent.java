...
public class GrammarCellsSubstituteMenu_IRequiresContent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IRequiresContent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_1vxmwf_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IRequiresContent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_1vxmwf_a extends GrammarCellsSubstituteMenuPart {
    @Override
