...
/*package*/ class ArithmeticExp_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ArithmeticExp_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_aj1u0c_a");
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            {
              ...
              SNode child = SLinkOperations.getTarget(node, LINKS.left$t7TI);
              ...
              if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.ConstraintExp$S1))) {
                SNodeFactoryOperations.setNewChild(node, LINKS.left$t7TI, null);
                return;
              }
            }

            SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.right$tdj5));
          ...
          public boolean canExecute_inReadAction(EditorContext editorContext) {
            ...
            SNode replacement = SLinkOperations.getTarget(node, LINKS.right$tdj5);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_aj1u0c_a0a(myNode, LINKS.left$t7TI, getEditorContext());
    return provider.createCell();
  }
  private static class leftSingleRoleHandler_aj1u0c_a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public leftSingleRoleHandler_aj1u0c_a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.left$t7TI, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.left$t7TI, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.left$t7TI);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.left$t7TI));
      try {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_aj1u0c_a0b0");
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            {
              // replace with placeholder
              SNode child = SLinkOperations.getTarget(node, LINKS.right$tdj5);
              SAbstractConcept childConcept = SNodeOperations.getConcept(child);
              if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.ConstraintExp$S1))) {
                SNodeFactoryOperations.setNewChild(node, LINKS.right$tdj5, null);
                return;
              }
            }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_aj1u0c_a2a(myNode, LINKS.right$tdj5, getEditorContext());
    return provider.createCell();
  }
  private static class rightSingleRoleHandler_aj1u0c_a2a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public rightSingleRoleHandler_aj1u0c_a2a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.right$tdj5, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.right$tdj5, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.right$tdj5);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.right$tdj5));
      try {
        EditorCell editorCell = super.createEmptyCell();
