...
public class GrammarCellsSubstituteMenu_IModelContent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IModelContent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_prbvb2_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IModelContent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_prbvb2_a extends GrammarCellsSubstituteMenuPart {
    @Override
