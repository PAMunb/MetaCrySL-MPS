...
public class GrammarCellsSubstituteMenu_ObjectSpec extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObjectSpec() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_1r6w2j_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObjectSpec", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_1r6w2j_a extends GrammarCellsSubstituteMenuPart {
    @Override
