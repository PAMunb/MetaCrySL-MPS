...
public class GrammarCellsSubstituteMenu_BaseSpecType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BaseSpecType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_wc1jyp_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BaseSpecType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_wc1jyp_a extends GrammarCellsSubstituteMenuPart {
    @Override
