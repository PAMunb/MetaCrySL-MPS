...
public class GrammarCellsSubstituteMenu_SpecContent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_SpecContent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ux9pzl_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "SpecContent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ux9pzl_a extends GrammarCellsSubstituteMenuPart {
    @Override
