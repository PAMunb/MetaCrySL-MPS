...
/*package*/ class AddEvent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new eventSingleRoleHandler_6obabd_b0(myNode, LINKS.event$rxbM, getEditorContext());
    return provider.createCell();
  }
  private static class eventSingleRoleHandler_6obabd_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public eventSingleRoleHandler_6obabd_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_6obabd_c0");
    Style style = new StyleImpl();
