...
public class GrammarCellsSubstituteMenu_ConstraintSpec extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ConstraintSpec() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_a35m0a_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ConstraintSpec", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_a35m0a_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ConstraintSpec$xj;
    }
  }
