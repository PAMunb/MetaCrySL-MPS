...
public class GrammarCellsSubstituteMenu_AddConstraint extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AddConstraint() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_mex80x_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AddConstraint", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_mex80x_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AddConstraint$aH;
    }
  }
