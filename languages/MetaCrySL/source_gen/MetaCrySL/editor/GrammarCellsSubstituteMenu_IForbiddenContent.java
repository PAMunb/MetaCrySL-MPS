...
public class GrammarCellsSubstituteMenu_IForbiddenContent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IForbiddenContent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_woz5au_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IForbiddenContent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_woz5au_a extends GrammarCellsSubstituteMenuPart {
    @Override
