...
public class GrammarCellsSubstituteMenu_MethodDef extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_MethodDef() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_5b2cx0_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "MethodDef", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_5b2cx0_a extends GrammarCellsSubstituteMenuPart {
    @Override
