...
public class GrammarCellsSubstituteMenu_EventMethod extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EventMethod() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_swkjpb_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EventMethod", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_swkjpb_a extends GrammarCellsSubstituteMenuPart {
    @Override
