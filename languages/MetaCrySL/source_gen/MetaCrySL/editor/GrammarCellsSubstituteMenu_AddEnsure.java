...
public class GrammarCellsSubstituteMenu_AddEnsure extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AddEnsure() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_90ryvl_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AddEnsure", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_90ryvl_a extends GrammarCellsSubstituteMenuPart {
    @Override
