...
public class GrammarCellsSubstituteMenu_QualifiedName extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_QualifiedName() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_j37ys5_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "QualifiedName", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_j37ys5_a extends GrammarCellsSubstituteMenuPart {
    @Override
