...
public class GrammarCellsSubstituteMenu_JavaQualifiedName extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_JavaQualifiedName() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_qlni38_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "JavaQualifiedName", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_qlni38_a extends GrammarCellsSubstituteMenuPart {
    @Override
