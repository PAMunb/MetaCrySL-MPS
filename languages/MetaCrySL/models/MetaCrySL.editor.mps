...
<model ref="r:baf14e14-5aad-49ff-afdc-75f27d6f7047(MetaCrySL.editor)">
  ...
  <node concept="24kQdi" id="3uqyculWYcL">
    ...
    <node concept="3EZMnI" id="4_NpUNletW0" role="2wV5jI">
      ...
      <node concept="3EZMnI" id="4_NpUNleRSx" role="3EZMnx">
        <node concept="VPM3Z" id="4_NpUNleRSz" role="3F10Kt" />
        <node concept="3F0ifn" id="4_NpUNleRS_" role="3EZMnx">
          <property role="3F0ifm" value="---&gt;" />
        </node>
        <node concept="3F2HdR" id="4_NpUNleRT3" role="3EZMnx">
          <ref role="1NtTu8" to="qgj4:4_NpUNleRT0" resolve="content" />
          <node concept="2iRfu4" id="4_NpUNleRT5" role="2czzBx" />
        </node>
        <node concept="2iRfu4" id="4_NpUNleRSA" role="2iSdaV" />
      </node>
    </node>
  </node>
  <node concept="24kQdi" id="3uqyculXeA5">
    <ref role="1XX52x" to="qgj4:3uqyculXeyX" resolve="QualifiedName" />
    <node concept="3F0A7n" id="3uqyculXeA7" role="2wV5jI">
      <ref role="1NtTu8" to="qgj4:3uqyculXezE" resolve="name" />
    </node>
  </node>
</model>
